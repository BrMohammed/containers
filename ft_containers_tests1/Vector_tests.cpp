...
void vector_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
         ...
         * Var to store the size and the capacity
         */
        size_t z1=0, z2=0, z3=0, ft_z1=0, ft_z2=0, ft_z3=0;
        size_t c1=0, c2=0, c3=0, ft_c1=0, ft_c2=0, ft_c3=0;
        ...
        c2 = v1.capacity();
        ft_c2 = ft_v1.capacity();
        // std::cerr << "\n"<< c2 << " " << "ftc : "<< ft_c2 << std::endl;
        // std::cerr << z2 << " " << "ft : "<< ft_z2 << std::endl;
        for (size_t i = 0; i < v1.size(); ++i)
            s3 += v1.at(i);
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        // /*------------------------------- test 4: the vector capacity < size + n && n <= size ----------------------------------------*/
        {
            std::vector<std::string> v(20, "string");
            ft::vector<std::string> ft_v(20, "string");
            // std::cerr << "\n" << v.capacity() << " ftc : " << ft_v.capacity() << std::endl;
            // std::cerr  << v.size() << " fts : " << ft_v.size() << std::endl;
